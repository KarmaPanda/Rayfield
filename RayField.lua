    ...
    for _, TabPage in ipairs(Elements:GetChildren()) do
        for _, Element in ipairs(TabPage:GetChildren()) do
            if Element.ClassName == "Frame" and Element.Name ~= "Placeholder" and
                Element.Name ~= "SectionSpacing" and Element.Name ~=
                "SectionTitle" then
            ...
            spawn(function()
                if RayfieldLibrary.Flags[FlagName].Type == "Colorpicker" then
                    ...
                    if RayfieldLibrary.Flags[FlagName].CurrentValue or
                        ...
                        RayfieldLibrary.Flags[FlagName].CurrentOption ~=
                        FlagValue then
            ...
            for _, element in ipairs(tab:GetChildren()) do
                if element.ClassName == "Frame" then
                    if element.Name ~= "SectionSpacing" and element.Name ~=
                        ...
                        for _, child in ipairs(element:GetChildren()) do
                            if child.Name ~= 'Description' and
                                (child.ClassName == "Frame" or child.ClassName ==
                                    "TextLabel" or child.ClassName == "TextBox" or
                                    child.ClassName == "ImageButton" or
                                    child.ClassName == "ImageLabel") then
                                child.Visible = true
        ...
        if page ~= 'Template' then
            for _, Element in pairs(page:GetChildren()) do
                if Element:IsA("Frame") and Element.Name ~= 'Placeholder' and
                    Element.Name ~= 'SectionSpacing' and
                    not Element:GetAttribute('SectionTitle') then
                    if InputText == "" or
...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    if Settings.KeySystem then
        ...
        if Settings.KeySettings.GrabKeyFromSite then
            local Success, Response = pcall(function()
                Settings.KeySettings.Key =
                    game:HttpGet(Settings.KeySettings.Key)
            end)
            if not Success then
                print("Rayfield | " .. Settings.KeySettings.Key .. " Error " ..
                          tostring(Response))
            end
        end
        ...
        if isfile(RayfieldFolder .. "/Key System" .. "/" ..
                      Settings.KeySettings.FileName .. ConfigurationExtension) then
            if readfile(RayfieldFolder .. "/Key System" .. "/" ..
                            Settings.KeySettings.FileName ..
                            ConfigurationExtension) == Settings.KeySettings.Key then
                Passthrough = true
            end
        end
        ...
        if not Passthrough then
            ...
            KeyMain.Subtitle.Text = Settings.KeySettings.Subtitle or
                                        "Key System"
            KeyMain.NoteMessage.Text = Settings.KeySettings.Note or
                                           "No instructions"
            ...
            TweenService:Create(KeyMain,
                                TweenInfo.new(0.6, Enum.EasingStyle.Quint),
                                {BackgroundTransparency = 0}):Play()
            TweenService:Create(KeyMain,
                                TweenInfo.new(0.6, Enum.EasingStyle.Quint),
                                {Size = UDim2.new(0, 500, 0, 187)}):Play()
            TweenService:Create(KeyMain.EShadow,
                                TweenInfo.new(0.5, Enum.EasingStyle.Quint),
                                {ImageTransparency = 0.5}):Play()
            wait(0.05)
            TweenService:Create(KeyMain.Title,
                                TweenInfo.new(0.4, Enum.EasingStyle.Quint),
                                {TextTransparency = 0}):Play()
            TweenService:Create(KeyMain.Subtitle,
                                TweenInfo.new(0.5, Enum.EasingStyle.Quint),
                                {TextTransparency = 0}):Play()
            wait(0.05)
            TweenService:Create(KeyMain.KeyNote,
                                TweenInfo.new(0.5, Enum.EasingStyle.Quint),
                                {TextTransparency = 0}):Play()
            TweenService:Create(KeyMain.Input,
                                TweenInfo.new(0.5, Enum.EasingStyle.Quint),
                                {BackgroundTransparency = 0}):Play()
            ...
            TweenService:Create(KeyMain.Input.InputBox,
                                ...
                                {TextTransparency = 0}):Play()
            wait(0.05)
            TweenService:Create(KeyMain.NoteTitle,
                                TweenInfo.new(0.4, Enum.EasingStyle.Quint),
                                {TextTransparency = 0}):Play()
            TweenService:Create(KeyMain.NoteMessage,
                                TweenInfo.new(0.4, Enum.EasingStyle.Quint),
                                {TextTransparency = 0}):Play()
            wait(0.15)
            TweenService:Create(KeyMain.Hide,
                                TweenInfo.new(0.4, Enum.EasingStyle.Quint),
            ...
            KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
                if KeyMain.Input.InputBox.Text == Settings.KeySettings.Key then
                    ...
                    TweenService:Create(KeyMain, TweenInfo.new(0.6,
                        ...
                        :Play()
                    TweenService:Create(KeyMain.EShadow, TweenInfo.new(0.5,
                                                                       Enum.EasingStyle
                                                                           .Quint),
                                        {ImageTransparency = 1}):Play()
                    ...
                    TweenService:Create(KeyMain.Input, TweenInfo.new(0.5,
                                                                     Enum.EasingStyle
                                                                         .Quint),
                                        {BackgroundTransparency = 1}):Play()
                    TweenService:Create(KeyMain.Input.UIStroke, TweenInfo.new(
                                            0.5, Enum.EasingStyle.Quint),
                                        {Transparency = 1}):Play()
                    TweenService:Create(KeyMain.Input.InputBox, TweenInfo.new(
                                            0.5, Enum.EasingStyle.Quint),
                                        {TextTransparency = 1}):Play()
                    ...
                    if Settings.KeySettings.SaveKey then
                        if writefile then
                            writefile(RayfieldFolder .. "/Key System" .. "/" ..
                                          Settings.KeySettings.FileName ..
                    ...
                    if AttemptsRemaining == 0 then
                        ...
                        TweenService:Create(KeyMain.Shadow.Image,
                                            TweenInfo.new(0.5, Enum.EasingStyle
                                                              .Quint),
                                            {ImageTransparency = 1}):Play()
                        TweenService:Create(KeyMain.Title, TweenInfo.new(0.4,
                                                                         Enum.EasingStyle
                        ...
                        TweenService:Create(KeyMain.Input.InputBox,
                                            TweenInfo.new(0.5, Enum.EasingStyle
                                                              .Quint),
                                            {TextTransparency = 1}):Play()
                        TweenService:Create(KeyMain.NoteTitle, TweenInfo.new(
                                                0.4, Enum.EasingStyle.Quint),
                                            {TextTransparency = 1}):Play()
                        TweenService:Create(KeyMain.NoteMessage, TweenInfo.new(
                                                0.4, Enum.EasingStyle.Quint),
                                            {TextTransparency = 1}):Play()
                        TweenService:Create(KeyMain.Hide, TweenInfo.new(0.4,
                                                                        Enum.EasingStyle
                    ...
                    TweenService:Create(KeyMain, TweenInfo.new(0.6,
                                        ...
                                        {Size = UDim2.new(0, 467, 0, 175)})
                        :Play()
                    TweenService:Create(KeyMain, TweenInfo.new(0.4,
                                                               Enum.EasingStyle
                                                                   .Elastic), {
    ...
    if Settings.KeySystem then repeat wait() until Passthrough end
    ...
    function Window:CreateTab(Name, Image)
        ...
        if Image then
            ...
            TabButton.Size = UDim2.new(0, TabButton.Title.TextBounds.X + 46, 0,
                                       30)
        end
        ...
        if FirstTab then
            ...
            TweenService:Create(TabButton,
                                TweenInfo.new(0.7, Enum.EasingStyle.Quint),
                                {BackgroundTransparency = 0.7}):Play()
            TweenService:Create(TabButton.Title,
                                TweenInfo.new(0.7, Enum.EasingStyle.Quint),
                                {TextTransparency = 0.2}):Play()
            TweenService:Create(TabButton.Image,
                                TweenInfo.new(0.7, Enum.EasingStyle.Quint),
                                {ImageTransparency = 0.2}):Play()
            TweenService:Create(TabButton.UIStroke,
                                TweenInfo.new(0.7, Enum.EasingStyle.Quint),
                                {Transparency = 0}):Play()

            TweenService:Create(TabButton.Shadow,
                                TweenInfo.new(0.3, Enum.EasingStyle.Quint),
                                {ImageTransparency = 0.7}):Play()
        else
            FirstTab = Name
        ...
        TabButton.Interact.MouseButton1Click:Connect(function()
            ...
            for _, OtherTabButton in ipairs(TabList:GetChildren()) do
                if OtherTabButton.Name ~= "Template" and
                    ...
                    TabButton and OtherTabButton.Name ~= "Placeholder" then
                    ...
                    TweenService:Create(OtherTabButton.Image,
                                        TweenInfo.new(0.7,
                                                      Enum.EasingStyle.Quint),
                                        {ImageTransparency = 0.2}):Play()
                    TweenService:Create(OtherTabButton.Shadow, TweenInfo.new(
                                            0.3, Enum.EasingStyle.Quint),
                                        {ImageTransparency = 0.7}):Play()
                    TweenService:Create(OtherTabButton.UIStroke, TweenInfo.new(
                                            0.7, Enum.EasingStyle.Quint),
                                        {Transparency = 0}):Play()
                end
            end
            if Elements.UIPageLayout.CurrentPage ~= TabPage then
                TweenService:Create(Elements,
                        ...
                        game:GetService('TweenService'):Create(Button,
                                                               TweenInfo.new(
                                                                   ...
                                                                   Enum.EasingDirection
                                                                       .Out), {
                            Size = UDim2.new(1, -10, 0, osize +
                                                 Button.Description.Size.Y
                                                     .Offset + 15)
                        }):Play()
                    end
                end)
        ...
        function Tab:CreateParagraph(ParagraphSettings)
            ...
            Paragraph.Content.Size = UDim2.new(0, 438, 0,
                                               Paragraph.Content.TextBounds.Y)
            -- Paragraph.Content.Position = UDim2.new(1, -10, 0,76)
            Paragraph.Size = UDim2.new(1, -10, 0,
                                       Paragraph.Content.TextBounds.Y + 40)
            ...
            if InputSettings.Info then
                ...
                Input.MouseEnter:Connect(function(x, y)
                    ...
                    if IsHover then
                        ...
                        game:GetService('TweenService'):Create(Input,
                                                               TweenInfo.new(
                                                                   0.4,
                                                                   Enum.EasingStyle
                                                                       .Quint,
                                                                   Enum.EasingDirection
                                                                       .Out), {
                            Size = UDim2.new(1, -10, 0, osize +
                                                 Input.Description.Size.Y.Offset +
                                                 15)
                        }):Play()
                    end
                end)
                Input.MouseLeave:Connect(function(x, y)
                    ...
                    if opened then
                        ...
                        delay(.4, function()
                            if not opened then
                                Input.Description.Visible = false
                            end
                        end)
                    end
                end)
            ...
            if KeybindSettings.Info then
                ...
                Keybind.MouseEnter:Connect(function(x, y)
                    ...
                    if IsHover then
                        ...
                        game:GetService('TweenService'):Create(Keybind,
                                                               TweenInfo.new(
                                                                   0.4,
                                                                   Enum.EasingStyle
                                                                       .Quint,
                ...
                Keybind.MouseLeave:Connect(function(x, y)
                    ...
                    if opened then
                        ...
                        delay(.4, function()
                            if not opened then
                                Keybind.Description.Visible = false
                            end
                        end)
                    end
                end)
            ...
            if ToggleSettings.Info then
                ...
                Toggle.MouseLeave:Connect(function(x, y)
                    ...
                    if opened then
                        ...
                        delay(.4, function()
                            if not opened then
                                Toggle.Description.Visible = false
                            end
                        end)
                    end
                end)
            ...
            if SliderSettings.Info then
                ...
                Slider.MouseEnter:Connect(function(x, y)
                    ...
                    if IsHover then
                        ...
                        game:GetService('TweenService'):Create(Slider,
                                                               TweenInfo.new(
                                                                   0.4,
                                                                   Enum.EasingStyle
                                                                       .Quint,
                ...
                Slider.MouseLeave:Connect(function(x, y)
                    ...
                    if opened then
                        ...
                        delay(.4, function()
                            if not opened then
                                Slider.Description.Visible = false
                            end
                        end)
                    end
                end)
                    ...
                    if Dragging then
                        ...
                        TweenService:Create(Slider.Main.Progress,
                                            TweenInfo.new(0.15,
                                                          ...
                                                          Enum.EasingDirection
                                                              .Out), {
                            Size = UDim2.new(0, Current -
                                                 Slider.Main.AbsolutePosition.X,
                                             1, 0)
                        }):Play()
                        local NewValue =
                            SliderSettings.Range[1] +
                        ...
                        TweenService:Create(Slider.Main.Progress,
                            ...
                            Size = UDim2.new(0,
                                             Location -
                                                 Slider.Main.AbsolutePosition.X >
                                                 5 and Location -
                                                 Slider.Main.AbsolutePosition.X or
                                                 5, 1, 0)
                        }):Play()
                        Loop:Disconnect()
                    end
